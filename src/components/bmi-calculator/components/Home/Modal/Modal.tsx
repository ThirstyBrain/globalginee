...
import maleIcon from '../../../../../assets/icons/Icon-male.svg';
import femaleIcon from '../../../../../assets/icons/icon-female.svg';
        ...
        <div className="gender-input">
          ...
          <div className="gender-container-btns">
            ...
            >
              ...
              <img src={femaleIcon} alt="Female Icon" style={{ width: '35px', height: '35px' }} />
            </button>
            <button
            ...
            >
              ...
              <img src={maleIcon} alt="Male Icon" style={{ width: '35px', height: '35px' }} />
            </button>
          </div>
        </div>
